...
export default function SocialsButtons({ data }) {
  return (
    <div className="flex items-center gap-x-3">
      <a 
        href={`https://www.facebook.com/sharer/sharer.php?u=${process.env.NEXT_PUBLIC_DOMAIN}/${data.slug}`} 
      ...
      <a 
        href={`https://twitter.com/intent/tweet?url=${process.env.NEXT_PUBLIC_DOMAIN}/${data.slug}`}
      ...
      <a 
        href={`https://www.linkedin.com/sharing/share-offsite/?url=${process.env.NEXT_PUBLIC_DOMAIN}/${data.slug}`} 
